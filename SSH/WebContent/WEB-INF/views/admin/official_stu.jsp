		...
		<form id="addForm">
			<table>
				...
				<tr>
					...
					<td>
						<select class="easyui-combobox" id="residence" name="stu.residence" style="width: 160px;">
							<option value="农村">农村户口</option>
							<option value="城市">城市户口</option>
						</select>
					</td>				
				</tr>
				<tr>
				...
				<tr>
					<td></td>
					<td>
						<a href="javascript:;" onclick="addStu();" class="easyui-linkbutton" data-options="iconCls:'icon-ok'">确认</a>
					</td>
				</tr>
			</table>
		</form>
	...
	<form id="editForm">
		...
		<table>
			...
			<tr>
				...
				<td style="padding: 5px;">户口性质</td>
				<td>
					<select class="easyui-combobox" name="stu.residence" style="width: 160px;">
						<option value="农村">农村户口</option>
						<option value="城市">城市户口</option>
					</select>
				</td>	

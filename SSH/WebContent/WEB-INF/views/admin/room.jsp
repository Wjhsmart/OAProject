...
<script>
	...
	function showCheckGrade() {
		...
		var roomId = $("#id").val();
		$("#stuWin").window("open");
		$.get("<%=path%>/stu/roomByPager?roomId=" + roomId, function(data) {
...
pageSize:20 每页显示多少条记录数  
 --%>
	...
	<div id="stuWin" class="easyui-window" title="查看宿舍学生" data-options="iconCls:'icon-search', closed:true" style="width: 900px; height: 450px;">
		...
		<div style="text-align: right; padding: 5px">
			<a href="javascript:void(0)" id="selectRoomStu" data-options="iconCls:'icon-ok'" class="easyui-linkbutton" onclick="addRoomStu();" style="display:none">设为宿舍长</a>
